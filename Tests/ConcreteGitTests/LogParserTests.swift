...
final class LogParserTests: XCTestCase {
    func testParseLogLineWithSHAAndSubject() {
        // given
        let line = "1622885092 7bc76cd  | fix: check if valid remote url"
        ...
        let expectedCommit = Commit(
            ...
            commitDate: Date(timeIntervalSince1970: 1622885092),
    ...
    func testParseLogWIthSHATagWithOtherRefsAndSubject() {
        // given
        let line = "1622885092 ec3a4b6 HEAD -> main, tag: v1.10.7, origin/main, origin/HEAD | chore(release): 1.10.7"
    ...
    func testParseLogWIthSHATagWithNoOtherRefsAndSubject() {
        // given
        let line = "1622885092 54d6657 tag: v1.10.5 | chore(release): 1.10.5"
